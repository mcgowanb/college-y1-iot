...
const String CLIENT_ID = " 980254550132-1vbah89q1coa472c52sbs14ne9js4l3t.apps.googleusercontent.com";

// the clientSecret found in Google's Developer Console under APIs & Auth > Credentials
const String CLIENT_SECRET = "gQdZnHkPaqxFwdBOt271pghY";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/CmmwG8CRgKixcV35jAzjb9bWG5jpFO1qGhDVF_5fziU";
...
// as described above.)
const String SPREADSHEET_TITLE = "YunSensor";
